...
chatBot integration ai (back & front)
-Agent IA avec Genkit + Gemini (chatbot)
-analyseNLP() + recommander() logements

## Fonction 4: Oussama Riahi

Intégration Google Maps (carte logements)
-Filtres carte : budget, type, localisation
